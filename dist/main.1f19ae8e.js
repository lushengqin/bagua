...
var n = 0;
var string2 = ''; //页面渲染的string2  处理过的直接用string会出现<
...
var step = function step() {
  setTimeout(function () {
    ...
    demo.scrollTo(0, 99999); // demo.innerHTML = string.substring(0,n) //不知道取值n  因为循环一个一个出来的 所以取n 可以实现动画效果 之前自己试一直取string.length 一下子就出来了 是因为写死了
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4034" + '/');
